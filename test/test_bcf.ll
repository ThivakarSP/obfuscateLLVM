...
@opaque_x = private global i32 81
...
15:                                               ; preds = %11
  %16 = load i32, ptr @opaque_x, align 4
  %17 = add i32 %16, 1
  %18 = mul i32 %16, %17
  %19 = srem i32 %18, 2
  %20 = icmp eq i32 %19, 0
  br i1 %20, label %real_path, label %bogus_path

real_path:                                        ; preds = %bogus_path, %15
