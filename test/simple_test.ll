; ModuleID = 'test\simple_test.c'
source_filename = "test\\simple_test.c"
...
$"??_C@_0BF@CEPOCOFD@Simple?5Test?5Program?6?$AA@" = comdat any

$"??_C@_0O@FDJKEPMC@?$CFd?5?$CL?5?$CFd?5?$DN?5?$CFd?6?$AA@" = comdat any

$"??_C@_0BI@MPHBLBF@Sum?5is?5greater?5than?525?6?$AA@" = comdat any

$"??_C@_0BD@CFHHDJMO@Sum?5is?525?5or?5less?6?$AA@" = comdat any

@"??_C@_0BF@CEPOCOFD@Simple?5Test?5Program?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [21 x i8] c"Simple Test Program\0A\00", comdat, align 1
...
@"??_C@_0BI@MPHBLBF@Sum?5is?5greater?5than?525?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [24 x i8] c"Sum is greater than 25\0A\00", comdat, align 1
@"??_C@_0BD@CFHHDJMO@Sum?5is?525?5or?5less?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [19 x i8] c"Sum is 25 or less\0A\00", comdat, align 1
...
define dso_local i32 @main() #0 {
  ...
  %8 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BF@CEPOCOFD@Simple?5Test?5Program?6?$AA@")
  %9 = load i32, ptr %4, align 4
  %10 = load i32, ptr %3, align 4
  %11 = load i32, ptr %2, align 4
  %12 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0O@FDJKEPMC@?$CFd?5?$CL?5?$CFd?5?$DN?5?$CFd?6?$AA@", i32 noundef %11, i32 noundef %10, i32 noundef %9)
  %13 = load i32, ptr %4, align 4
  %14 = icmp sgt i32 %13, 25
  br i1 %14, label %15, label %17

15:                                               ; preds = %0
  %16 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BI@MPHBLBF@Sum?5is?5greater?5than?525?6?$AA@")
  br label %19

17:                                               ; preds = %0
  %18 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0BD@CFHHDJMO@Sum?5is?525?5or?5less?6?$AA@")
  br label %19
...
!1 = !DIFile(filename: "test\\simple_test.c", directory: "C:\\Users\\snave\\Desktop\\Obfuscate_LLVM")
